...
public class MoveNorth implements Move
{
    ...
    /* SUBMODULE: MoveNorth
	   ...
	   EXPORT: none
	   ASSERTION: Constructor for MoveNorth */
    public MoveNorth(String[][] inMap, Map<String,Grid> inGridMap, Player inPlayer)
    {
        this.map = inMap;
    ...
    public void movePlayer()
    {
        ...
        || map[player.getRow() - 1][player.getCol()].contains("\u2592")) // if no obstacle or is door
        {
            String doorColour = "";
            ...
            || player.hasKey(doorColour))
            {
                ...
                {
                    // there is nothing in the cell above, player can just move there
                ...
                Maze.logger.info(() -> "Player moved up a grid square.\n" +
